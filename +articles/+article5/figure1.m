...
ha=slj.Plot.subplot(2,2,[0.01,0.1],[0.13,0.07],[0.1,0.02]);
...
annotation(f,'textbox',...
    [0.303 0.497000001609325 0.0554999986439944 0.0739999983906746],...
    'String',{'Ez'},...
    'LineStyle','none',...
    'FontSize',18,...
...
annotation(f,'textbox',...
    [0.665 0.499000001609325 0.0554999986439944 0.0739999983906746],...
    'String',{'Ez'},...
    'LineStyle','none',...
    'FontSize',18,...
    'FontName','Times New Roman',...
    'BackgroundColor',[1 1 1]);
annotation(f,'textbox',...
    [0.299 0.195000001609326 0.0614999984651804 0.0739999983906746],...
    'String',{'Tic'},...
    'LineStyle','none',...
    'FontSize',18,...
    'FontName','Times New Roman',...
    'BackgroundColor',[1 1 1]);
annotation(f,'textbox',...
    [0.659 0.195000001609326 0.0614999984651804 0.0739999983906746],...
    'String',{'Tic'},...
    'LineStyle','none',...
    'FontSize',18,...
    'FontName','Times New Roman',...
    'BackgroundColor',[1 1 1]);
annotation(f,'textbox',...
    [0.166 0.697000001311302 0.0464999989122153 0.0639999986886979],...
    'String',{'(a)'},...
    'LineStyle','none',...
    'FontSize',14,...
    'FontName','Times New Roman',...
    'BackgroundColor',[1 1 1]);
annotation(f,'textbox',...
    [0.526 0.697000001311302 0.047499998882413 0.0639999986886979],...
    'String',{'(b)'},...
    'LineStyle','none',...
    'FontSize',14,...
    'FontName','Times New Roman',...
    'BackgroundColor',[1 1 1]);
annotation(f,'textbox',...
    [0.166 0.395000001311303 0.0464999989122153 0.0639999986886979],...
    'String',{'(c)'},...
    'LineStyle','none',...
    'FontSize',14,...
    'FontName','Times New Roman',...
    'BackgroundColor',[1 1 1]);
annotation(f,'textbox',...
    [0.526 0.395000001311303 0.047499998882413 0.0639999986886979],...
    'String',{'(d)'},...
    'LineStyle','none',...
    'FontSize',14,...
    'FontName','Times New Roman',...
