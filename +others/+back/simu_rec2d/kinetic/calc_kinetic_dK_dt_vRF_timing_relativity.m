function [K,flux,we,wp,cv]=calc_kinetic_dK_dt_vRF_timing_relativity(q,m,n,vx,vy,vz,ex,ey,ez,p,grids,Lx,Ly,z0,bzp,bzn,wci,di,c)
%% calculate dK/dt
...
[K,flux,we,wp]=calc_kinetic_partial_t_relativity(q,m,n,vx,vy,vz,ex,ey,ez,p,grids,c);
