function [h1,h2]=plot_veldist4(fd,norm,b0)
...
%%
figure
h1=subplot('position',[0.3,0.5,0.35,0.35]);
...
set(gca,'fontsize',12,'linewidth',0.5,'dataaspectratio',[1 1 1],...
    'xminortick','on','yminortick','on')
xlabel(string{1},'fontsize',12)
ylabel(string{2},'fontsize',12)
%
...
dist(ind)=NaN;
%%
h2=subplot('position',[0.3,0.1,0.35,0.35]);
% pcolor(vv,vv,log10(dist)); shading flat
pcolor(vv,vv,dist); shading flat
colorbar;
hold on
...
set(gca,'fontsize',12,'linewidth',0.5,'dataaspectratio',[1 1 1],...
       'xminortick','on','yminortick','on')
xlabel(string{2},'fontsize',12)
ylabel(string{3},'fontsize',12)
