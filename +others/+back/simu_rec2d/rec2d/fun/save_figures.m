...
elseif strcmp('Ne',var) || strcmp('Ni',var) || strcmp('Densi',var) || strcmp('Dense',var)
    ...
    is_exist_dir(var);
    cd(var);
elseif strcmp('Ti_aver',var) || strcmp('Ti_perp',var) || strcmp('Ti_para',var) || strcmp('Ti_anis',var)
    is_exist_dir('T');
    cd('T');
    is_exist_dir('Ti');
    cd('Ti');
    is_exist_dir(var);
    cd(var);
elseif strcmp('Te_aver',var) || strcmp('Te_perp',var) || strcmp('Te_para',var) || strcmp('Te_anis',var)
    is_exist_dir('T');
    cd('T');
    is_exist_dir('Te');
    cd('Te');
