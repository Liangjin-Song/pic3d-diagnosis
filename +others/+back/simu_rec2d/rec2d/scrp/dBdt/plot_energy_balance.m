...
outdir='/data/simulation/rec2d_M25SBg00Sx/out/dB_dt/X/';
tt=50:97;
ndx=4000;
ndy=2000;
di=20;
...
for t=1:nt-1
    ...
    hl=legend([h1(:);h2],'Transport','Local energy conversion','Compression','Total','Bz','Location','Best');
    set(hl,'Orientation','horizon');
    %% save figures
    cd(outdir);
    print('-r300','-dpng',['Energy_balance_Bz_t',num2str(tp,'%06.2f'),'.png']);
    close(gcf);
end
