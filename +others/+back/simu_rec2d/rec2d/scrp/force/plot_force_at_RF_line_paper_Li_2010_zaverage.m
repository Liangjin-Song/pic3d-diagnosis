...
outdir='/data/simulation/rec2d_M100SBg00Sx/out/force/line/z=aver/';
tt=20:0.5:60;
c=0.6;
n0=1304.33557;
vA=0.03;
...
for t=1:nt
    ...
    lc=mean(curvx(nz0-haver:nz0+haver,:));
    lp=mean(gradx(nz0-haver:nz0+haver,:));
    ...
    %% save figures
    cd(outdir);
    print('-r300','-dpng',['Force_balance_Bz_z=aver_t',num2str(tt(t),'%06.2f'),'.png']);
    close(gcf);
end
