%% plot multi thermal line for electron
% writen by Liangjin Song on 20190808
clear;
indir='/data/simulation/rec2d_M100SBg00Sx/data/';
outdir='/data/simulation/rec2d_M100SBg00Sx/out/thermal/electron/';
di=40;
ndx=4800;
ndy=2400;
Lx=ndx/di; Ly=ndy/di;
...
cd(indir);
p1=read_data('prese',t1);
p2=read_data('prese',t2);
p3=read_data('prese',t3);
p4=read_data('prese',t4);
p5=read_data('prese',t5);
