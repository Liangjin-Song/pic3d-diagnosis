...
outdir='/data/simulation/rec2d_M100SBg00Sx/out/thermal/electron/X/';
tt=0:0.5:100;
di=40;
ndx=4800;
ndy=2400;
...
for t=1:nt
    ...
    xrange=[0,Lx];
    ylab='electron thermal energy';
    plotyy_with_bz(lue,lbz,lx,ylab,xrange);

    cd(outdir);
    print('-r200','-dpng',['electron_thermal_energy_density_t',num2str(tt(t),'%06.2f'),'.png']);
    close(gcf);
end
