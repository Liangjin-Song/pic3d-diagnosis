...
outdir = 'E:\PIC\Cold-Ions\mie100\out\R0\X-line\Cold';
...
t1=10;
t2=20;
time.range=round((t1/prm.value.wci+1):(t2/prm.value.wci+1));

t0=15;
time.t0=round(t0/prm.value.wci+1);
