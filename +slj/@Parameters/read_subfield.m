function fd = read_subfield(value, name, time, suffix, nx, ny, nz)
%%
% @info: writen by Liangjin Song on 20221129
...
% @param: nx, ny, nz -- the dimensions of the field
%%
filename=[name,'_t',num2str(time,'%07.3f'),'_', suffix, '.bsd'];
